...
function feedbackProfile(feedback) {
  if (feedback === "keep") {
    return { direction: "positive", weight: 0.5, strength: "keep" };
  }
  if (feedback === "upgrade") {
    return { direction: "positive", weight: 1, strength: "upgrade" };
  }
  if (feedback === "downgrade") {
    return { direction: "negative", weight: 1, strength: "downgrade" };
  }
  if (feedback === "drop") {
    return { direction: "negative", weight: 1.8, strength: "drop" };
  }
  return { direction: "ignored", weight: 0, strength: "ignored" };
}
