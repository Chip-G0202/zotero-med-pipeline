...
export const DOI_PREFIX_JOURNAL_MAP = [
  { prefix: "10.1186/s12974", journal: "Journal of Neuroinflammation" },
  { prefix: "10.1186/s12940", journal: "Environmental Health" },
];

/** URL path segment → journal name mapping. */
const URL_PATH_JOURNAL_MAP = [
  { host: "academic.oup.com", pathPrefix: "/brain/", journal: "Brain" },
];
 ...
 * Example: ".../10.1186/s12974-026-03897-x" → 12974
