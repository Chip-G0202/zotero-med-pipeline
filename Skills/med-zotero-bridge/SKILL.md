...
description: Zotero桥接技能。Use MCP-only for literature information read/write/move (collections/items/rating migration), while keeping PDF acquisition via Zotero Find Available PDF and Edge+Zotero Connector.
---
