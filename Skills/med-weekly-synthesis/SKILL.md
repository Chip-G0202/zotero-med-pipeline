...
- Daily: `<reviewRoot>/<yy WeekWW>/<yy.M.d>/隔日报.xlsx`
- Biweekly: `<reviewRoot>/<yy WeekWW>/双周报-<start>_<end>.docx`
...
4. Biweekly export (双周报-*.docx):
- Generated by `biweekly_docx_report.mjs`
