...
description: 筛选标准文件管理与规则建议流程技能。Use when managing screening_standards.md/docx lifecycle, processing rule suggestions, syncing docx markup, or parsing screening standards into structured rules.
---
