...
description: 反馈驱动检索偏好学习技能。Use when building next-cycle PubMed/PMC queries from previous every-other-day feedback/comment without changing downstream triage logic.
---
