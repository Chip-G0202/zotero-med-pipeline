...
description: XLSX/DOCX 导出策略与 fallback 链技能。Use when exporting 隔日报.xlsx or 月报-*.docx, determining export method, recording audit fields, or troubleshooting export failures.
---
